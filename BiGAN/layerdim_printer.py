...
print('for the original 32x32 input model')
H_out, W_out = layerdimprint([32, 32], 4,2,1)
H_out, W_out = layerdimprint([H_out, W_out], 4,2,1)
H_out, W_out = layerdimprint([H_out, W_out], 4,2,1)
H_out, W_out = layerdimprint([H_out, W_out], 4,1,0)
#H_out, W_out = layerdimprint([H_out, W_out], 1,1,0)

print('for the expanded 256 input model:')

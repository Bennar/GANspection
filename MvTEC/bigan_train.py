...
from utils import DeterministicConditional, JointCritic, WALI
...
def create_generator():
  mapping = nn.Sequential(
    ConvTranspose2d(NLAT, FEATURES_GEN * 16, 4, 1, 0, bias=False), BatchNorm2d(FEATURES_GEN * 16), ReLU(),
    ConvTranspose2d(FEATURES_GEN * 16, FEATURES_GEN * 8, 4, 2, 1, bias=False), BatchNorm2d(FEATURES_GEN * 8), ReLU(),
    ConvTranspose2d(FEATURES_GEN * 8, FEATURES_GEN * 4, 4, 2, 1, bias=False), BatchNorm2d(FEATURES_GEN * 4), ReLU(),
    ConvTranspose2d(FEATURES_GEN * 4, FEATURES_GEN * 2, 4, 2, 1, bias=False), BatchNorm2d(FEATURES_GEN * 2), ReLU(),
    ConvTranspose2d(FEATURES_GEN * 2, NUM_CHANNELS, 4, 2, 1, bias=False), nn.Tanh())    
  return DeterministicConditional(mapping)
